...
class NeRFSystem(LightningModule):
    ...
    def on_train_start(self):
        self.model.mark_invisible_cells(torch.from_numpy(self.train_dataset.K).to(self.device),
                                        self.poses,
    ...
    def on_validation_start(self):
        ...
        if not self.hparams.no_save_test:
            ...
            self.val_dir = f'/data2_12t/dataset/OpenXD-OmniObject3D-New/results_img/{self.hparams.exp_name}'
